...
|  아이템 40  | [@Override 애너테이션을 일관되게 사용하라](https://github.com/TheSwiftists/effective-swift/blob/item40/6장_열거_타입과_애너테이션/item40.md) | override 키워드를 붙여야 하는 이유 | [delma](https://github.com/delmaSong) |

...
| 아이템 번호 | <center>타이틀</center> | <center>서브 타이틀</center> | 담당자 |
|:-----:|-------|-------|:------:|
| 아이템 57 | [지역변수의 범위를 최소화하라]() | 지역변수의 범위를 줄이는 2가지 기법 | [Lena][lena] |
...
| 아이템 77 | [예외를 무시하지 말라]() | Swift에서의 Error Handling | [Lena][lena] |
...
| 아이템 82 | [스레드 안전성 수준을 문서화하라]() | iOS에서의 Multi Thread Programming 체크 리스트 ✅ | [Lena][lena] |
